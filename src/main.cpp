...
const string strMessageMagic = "ZedCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 30 * 60;						// ZedCoin: every 30 mins
static const int64 nTargetSpacing = 60;								// ZedCoin: 1 min blocks
static const int64 nInterval = nTargetTimespan / nTargetSpacing;	// ZedCoin: 30 blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal zedcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZedCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "January 22, 2014 — Dawn of the Dead";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390439970;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2436599;

		if (fTestNet)
        {
            block.nTime    = 1389309270;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfca3aee739c40af61852516f56fbd640c338278339c3968394b23f9b5c34928d"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // ZedCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
